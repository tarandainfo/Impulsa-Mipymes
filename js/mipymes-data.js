...
const MIPYMES_DATA = [
...

    {
        ...
        whatsapp: "595971304087",

        instagram: "https://www.instagram.com/cheretacafe_/",

        productoImagen:
            "./assets/img/che-reta-cafe/foto-1.jpg",

        perfilImagen:
            "./assets/img/che-reta-cafe/foto-perfil-che-reta.png",

        fotosCarrusel: [
            "./assets/img/che-reta-cafe/foto-1.jpg",
            "./assets/img/che-reta-cafe/foto-2.jpg",
            "./assets/img/che-reta-cafe/foto-3.jpg"
        ],
